...
packetTypeMapping[PacketType.BUY_AND_EQUIP] = { value: "p​a​cket", side: Side.Server };
packetTypeMapping[PacketType.HEALTH_UPDATE] = { value: "hpupd", side: Side.Client };
...
packetTypeMapping[PacketType.SELECT_ITEM] = { value: "slct", side: Side.Server };
packetTypeMapping[PacketType.SELECT_UPGRADE] = { value: "6", side: Side.Server };
packetTypeMapping[PacketType.SET_ANGLE] = { value: "pa​cket", side: Side.Server };
...
packetTypeMapping[PacketType.UPDATE_HEALTH] = { value: "hpupd", side: Side.Client };
