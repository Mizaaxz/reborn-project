!(function (e) {
  ...
  function (e, t, n) {
    ...
    a.install({
      ...
      getExtPacker: function (e) {
        ...
        if (i) return i;
        for (
          var r = this.extEncoderList || (this.extEncoderList = []), s = r.length, a = 0;
          a < s;
          a++
        ) {
          var o = r[a];
        ...
        function h(e, c, h) {
          ...
          function O(e, t, r, c) {
            return this instanceof O
              ? (function (e, t, r, c, h) {
                  if (
                    (s && a && (t instanceof a && (t = new s(t)), c instanceof a && (c = new s(c))),
                    t || r || c || n)
                  ) {
    ...
    (function (t) {
      (e.exports.maxScreenWidth = 1920),
        ...
        (e.exports.fetchVariant = function (t) {
          for (
            var n = t.weaponXP[t.weaponIndex] || 0, i = e.exports.weaponVariants.length - 1;
            i >= 0;
            --i
          )
  ...
  function (e, t, n) {
                    ...
                    : ((ue.onclick = s.checkTrusted(function () {
                      ...
                      (ke.onclick = s.checkTrusted(function () {
                        "block" != Qe.style.display
                          ? ((Qe.style.display = "block"), (Ye.style.display = "none"), an(), Gt())
    ...
    function xt() {
      if (!cpmstarAPI || !kt)
        return console.log("Failed to load video ad API", !!cpmstarAPI, !!kt), void Tn();
    ...
    function Tt(e, t, n) {
      if (R && e)
        if (
          ...
          s.generateElement({ id: "itemInfoName", text: s.capitalizeFirst(e.name), parent: Fe }),
          s.generateElement({ id: "itemInfoDesc", text: e.desc, parent: Fe }),
          n)
        );
        else if (t)
          s.generateElement({
            ...
            (this.update = function (e, t) {
              this.active &&
                ...
                this.scale >= o.mapPingScale
                  ? (this.active = !1)
                  : ((e.globalAlpha = 1 - Math.max(0, this.scale / o.mapPingScale)),
                    e.beginPath(),
                    e.arc(
      ...
      window.addEventListener(
        ...
        s.checkTrusted(function (e) {
          if (R && R.alive) {
            ...
            13 == t
              ? rn()
              : kn() && gn[t] && ((gn[t] = 0), mn[t] ? bn() : 32 == t && ((O = 0), vn()));
          }
        })
      );
    var wn = void 0;
    ...
    function Tn() {
      I("moo_name", Le.value),
        !le &&
          ...
          x.stop("menu"),
          dt("Loading..."),
          r.send("sp", { name: Le.value, moofoll: H, skin: ae }));
    }
    var In = !0;
    function En(e) {
      (Pe.style.display = "none"),
        ...
        e.skinIndex > 0 &&
          ...
          (function e(t, n, i, r) {
            ...
            Gn.isLoaded && n.drawImage(Gn, -a.scale / 2, -a.scale / 2, a.scale, a.scale),
              !i &&
                a.topSprite &&
                (n.save(), n.rotate(r.skinRot), e(t + "_top", n, a, r), n.restore());
    ...
    function ei(e, t, n, i, r) {
      ...
      a ||
        ...
        (Zn[s] = a)),
        a.isLoaded &&
          r.drawImage(a, n + e.xOff - e.length / 2, i + e.yOff - e.width / 2, e.length, e.width);
    }
    var ti = {};
    function ni(e) {
    ...
    function ri(e, t) {
      ...
      if (!n || t) {
        ...
        if (
          ...
          r.fillStyle =
            "castle wall" == e.name ? "#83898e" : "wood wall" == e.name ? "#a5974c" : "#939393";
          var f = "castle wall" == e.name ? 4 : 3;
          ai(r, f, 1.1 * e.scale, 1.1 * e.scale),
            r.fill(),
            r.stroke(),
            (r.fillStyle =
              "castle wall" == e.name ? "#9da4aa" : "wood wall" == e.name ? "#c9b758" : "#bcbcbc"),
          ...
          var p = 2 * e.scale,
            ...
            m = -e.scale / 2;
          for (c = 0; c < 4; ++c)
            oi(m - g / 2, 0, g, 2 * e.scale, r), r.fill(), r.stroke(), (m += p / 4);
        } else
          "healing pad" == e.name
            ? ((r.fillStyle = "#7e7f82"),
              oi(0, 0, 2 * e.scale, 2 * e.scale, r),
    ...
    function hi(e, t) {
      (_ = Mi(t)) &&
        ((_.xWiggle += o.gatherWiggle * Math.cos(e)), (_.yWiggle += o.gatherWiggle * Math.sin(e)));
    }
    function ui(e, t) {
      (_ = Mi(e)) &&
        ((_.dir = t),
    ...
    (window.requestAnimFrame =
      ...
      (function e() {
        (B = Date.now()),
          ...
          (function () {
            if (
              (R && (!C || B - C >= 1e3 / o.clientSendRate) && ((C = B), r.send("2", pn())),
              An < 120 &&
                ((An += 0.1 * P), (Ge.style.fontSize = Math.min(Math.round(An), 120) + "px")),
              R)
            ) {
      ...
      o.addTest("passiveeventlisteners", function () {
        ...
        (function (e) {
          ...
          o._config.enableClasses &&
            ((t += " " + n + e.join(" " + n)), l ? (c.className.baseVal = t) : (c.className = t));
        })(r),
        delete a.addTest,
  ...
  function (e, t, n) {
    ...
    (t.byteLength = function (e) {
      ...
      (t.toByteArray = function (e) {
        ...
        return (
          2 === o &&
            ((t = (r[e.charCodeAt(n)] << 2) | (r[e.charCodeAt(n + 1)] >> 4)), (c[h++] = 255 & t)),
          1 === o &&
            ((t =
              (r[e.charCodeAt(n)] << 10) |
            ...
            : (192 == (224 & s)
                ...
                : 240 == (248 & s) &&
                  (s =
                    ...
                    (63 & this[i++])),
              s >= 65536
                ? ((s -= 65536), (r += String.fromCharCode(55296 + (s >>> 10), 56320 + (1023 & s))))
                : (r += String.fromCharCode(s)));
        return r;
      }),
        ...
        for (var n = t || (t |= 0), i = e.length, r = 0, s = 0; s < i; )
          (r = e.charCodeAt(s++)) < 128
            ...
            ? ((this[n++] = 224 | (r >>> 12)),
              (this[n++] = 128 | ((r >>> 6) & 63)),
              (this[n++] = 128 | (63 & r)))
            : ((r = 65536 + (((r - 55296) << 10) | (e.charCodeAt(s++) - 56320))),
              (this[n++] = 240 | (r >>> 18)),
              (this[n++] = 128 | ((r >>> 12) & 63)),
              (this[n++] = 128 | ((r >>> 6) & 63)),
              (this[n++] = 128 | (63 & r)));
  ...
  function (e, t) {
    ...
    (e.exports.randInt = function (e, t) {
      ...
      (e.exports.hookTouchEvents = function (t, n) {
        ...
        function s(n) {
          e.exports.mousifyTouchEvent(n),
            ...
            r && (t.onclick && t.onclick(n), t.onmouseout && t.onmouseout(n), (r = !1));
        }
        t.addEventListener(
          "touchstart",
      ...
      (e.exports.randomString = function (e) {
        for (
          var t = "", n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", i = 0;
          i < e;
          i++
        )
        ...
        (this.texts = []),
          (this.update = function (e, t, n, i) {
            ...
            for (var r = 0; r < this.texts.length; ++r)
              this.texts[r].life && (this.texts[r].update(e), this.texts[r].render(t, n, i));
          }),
      ...
      (this.sid = e),
        ...
        (this.getScale = function (e, t) {
          return (
            (e = e || 1),
            this.scale *
              (this.isItem || 2 == this.type || 3 == this.type || 4 == this.type ? 1 : 0.6 * e) *
              (t ? 1 : this.colDiv)
          );
        }),
        (this.visibleToPlayer = function (e) {
          return (
            !this.hideFromEnemy ||
            (this.owner && (this.owner == e || (this.owner.team && e.team == this.owner.team)))
          );
        }),
        (this.update = function (e) {
          this.active &&
      ...
      (this.getGridArrays = function (e, t, i) {
          ...
          this.grids[u + "_" + f] && m.push(this.grids[u + "_" + f]),
            e + i >= (u + 1) * d &&
              ...
              f && t - i <= f * d
                ...
                : t + i >= (f + 1) * d && (p = this.grids[u + 1 + "_" + (f + 1)]) && m.push(p)),
            u &&
              e - i <= u * d &&
              ((p = this.grids[u - 1 + "_" + f]) && m.push(p),
              f && t - i <= f * d
        ...
        (this.add = function (n, i, r, s, a, o, c, l, u) {
          ...
          g || ((g = new e(n)), t.push(g)),
            ...
            h && (this.setObjectGrids(g), g.doUpdate && this.updateObjects.push(g));
        }),
            ...
            if (f <= 0) {
              if (t.ignoreCollision)
                ...
                (t.owner && t.owner.team && t.owner.team == e.team)
                  ? t.boostSpeed
                    ? ((e.xVel += n * t.boostSpeed * (t.weightM || 1) * r(t.dir)),
                      (e.yVel += n * t.boostSpeed * (t.weightM || 1) * s(t.dir)))
                    : t.healCol
                    ? (e.healCol = t.healCol)
                    : t.teleport &&
                      ((e.x = o.randInt(0, c.mapScale)), (e.y = o.randInt(0, c.mapScale)))
          ...
          if (t) {
            for (var n = 0; n < this.items.length; ++n)
              if (p.list[this.items[n]].group == t.group)
                return (
                  this.buildIndex == this.items[n] && (this.buildIndex = e), (this.items[n] = e), !0
                );
      ...
      (this.update = function (e) {
        if (this.alive) {
          ...
          if (this.alive) {
            if (
              (this.slowMult < 1 &&
                ((this.slowMult += 8e-4 * e), this.slowMult > 1 && (this.slowMult = 1)),
              (this.noMovTimer += e),
              ...
              !this.zIndex &&
                ...
                (this.skin && this.skin.watrImm
                  ? ((i *= 0.75), (this.xVel += 0.4 * n.waterCurrent * e))
                  : ((i *= 0.33), (this.xVel += n.waterCurrent * e)));
            ...
            for (
              var y = l.getDistance(0, 0, this.xVel * e, this.yVel * e),
                k = Math.min(4, Math.max(1, Math.round(y / 40))),
                v = 1 / k,
                w = 0;
              w < k;
              ++w
            ...
            if (
              (this.xVel &&
                ((this.xVel *= o(n.playerDecel, e)),
                this.xVel <= 0.01 && this.xVel >= -0.01 && (this.xVel = 0)),
              this.yVel &&
                ((this.yVel *= o(n.playerDecel, e)),
                this.yVel <= 0.01 && this.yVel >= -0.01 && (this.yVel = 0)),
              this.x - this.scale < 0
                ? (this.x = this.scale)
                : this.x + this.scale > n.mapScale && (this.x = n.mapScale - this.scale),
              this.y - this.scale < 0
                ? (this.y = this.scale)
                : this.y + this.scale > n.mapScale && (this.y = n.mapScale - this.scale),
              this.buildIndex < 0)
            )
              if (this.reloads[this.weaponIndex] > 0)
                ...
                if (null != p.weapons[this.weaponIndex].gather) this.gather(f);
                  ...
                  null != p.weapons[this.weaponIndex].projectile &&
                  ...
                  p.weapons[this.weaponIndex].rec &&
                    ((this.xVel -= p.weapons[this.weaponIndex].rec * s(this.dir)),
                    (this.yVel -= p.weapons[this.weaponIndex].rec * a(this.dir))),
                    h.addProjectile(
                      this.x + E * s(this.dir),
                      this.y + E * a(this.dir),
                      this.dir,
                      p.projectiles[I].range * M,
                      p.projectiles[I].speed * M,
                      I,
                      this,
                      null,
                      this.zIndex
        ...
        (this.changeHealth = function (e, t) {
          ...
          e < 0 && this.skin && (e *= this.skin.dmgMult || 1),
            ...
            (this.health += e),
            this.health > this.maxHealth &&
              ((e -= this.health - this.maxHealth), (this.health = this.maxHealth)),
          ...
          return (
            !t ||
              !t.canSee(this) ||
              (t == this && e < 0) ||
              y.send(t.id, "t", Math.round(this.x), Math.round(this.y), Math.round(-e), 1),
            !0
          );
        }),
        (this.kill = function (e) {
          e &&
            ...
            e.skin && e.skin.goldSteal
              ...
              : k(e, Math.round(100 * this.age * (e.skin && e.skin.kScrM ? e.skin.kScrM : 1))),
        ...
        (this.buildItem = function (e) {
          ...
          if (
            ...
            (e.consume || u.checkItemLocation(n, i, e.scale, 0.6, e.id, !1, this))
          ) {
            var r = !1;
            if (e.consume) {
              if (this.hitTime) {
        ...
        (this.canBuild = function (e) {
          return (
            !!n.inSandbox ||
            (!(e.group.limit && this.itemCounts[e.group.id] >= e.group.limit) && this.hasRes(e))
          );
        }),
        (this.gather = function () {
                ...
                if (((h[t.sid] = 1), t.health)) {
                  if (
                    ...
                    for (var k = 0; k < t.req.length; )
                      this.addResource(n.resourceTypes.indexOf(t.req[k]), t.req[k + 1]), (k += 2);
                    u.disableObj(t);
                  }
                } else {
          ...
          for (y = 0; y < f.length + d.length; ++y)
            if (
              ...
              w &&
                t.addResource &&
                ((w = Math.min(t.points || 0, w)), this.addResource(3, w), t.addResource(3, -w));
              var b = c;
              null != t.weaponIndex &&
              ...
              (t.xVel += S * s(e)),
                ...
                !t.dmgOverTime ||
                  !o ||
                  (t.skin && t.skin.poisonRes) ||
                  ((t.dmgOverTime.dmg = 5), (t.dmgOverTime.time = 5), (t.dmgOverTime.doer = this)),
                t.skin &&
                  t.skin.dmgK &&
                  ((this.xVel -= t.skin.dmgK * s(e)), (this.yVel -= t.skin.dmgK * a(e))),
              ...
              if (m.isPlayer || m.isAI) {
                ...
                (m.xVel += v * Math.cos(this.dir)),
                  ...
                  (null != m.weaponIndex &&
                    ...
                    s.getAngleDist(this.dir + Math.PI, m.dir) <= r.shieldAngle) ||
                    m.changeHealth(-this.dmg, this.owner, this.owner);
              } else
                for (
                  m.projDmg && m.health && m.changeHealth(-this.dmg) && n.disableObj(m), f = 0;
                  f < e.length;
                  ++f
                )
                  e[f].active &&
      ...
      (this.sounds = []),
        ...
        (this.play = function (t, i, r) {
          i &&
            this.active &&
            ((n = this.sounds[t]) ||
              ((n = new Howl({ src: ".././sound/" + t + ".mp3" })), (this.sounds[t] = n)),
            (r && n.isPlaying) ||
  ...
  function (e, t, n) {
    ...
    (s.prototype.regionInfo = {
        ...
        if ("string" == typeof t) {
          ...
          if (3 == n.length) {
            var r = n[0],
              ...
              a = parseInt(n[2]);
            return (
              "0" == r || r.startsWith("vultr:") || (r = "vultr:" + r), [r, s, a, e.query.password]
            );
          }
      ...
      (s.prototype.serverAddress = function (e, t) {
        return "127.0.0.1" == e || "7f000001" == e || "903d62ef5d1c2fecdcaeb5e7dd485eff" == e
      ...
      (s.prototype.stripRegion = function (e) {
        return (
          e.startsWith("vultr:") ? (e = e.slice(6)) : e.startsWith("do:") && (e = e.slice(3)), e
        );
      }),
              ...
              for (var n in e)
                for (var i = e[n], r = 0; r < i.length; r++)
                  t.push({
                    ...
                    region: n,
                    index: r,
                    games: i[r].map((e) => ({ playerCount: e, isPrivate: !1 })),
                  });
              return t;
            })({
              1: [
  ...
  function (e, t, n) {
    ...
    (t.parse = v),
      ...
      (t.format = function (e) {
        return (
          r.isString(e) && (e = v(e)), e instanceof s ? e.format() : s.prototype.format.call(e)
        );
      }),
      (t.Url = s);
    var a = /^([a-z0-9.+-]+:)/i,
    ...
    (s.prototype.parse = function (e, t, n) {
      ...
      if (((v = v.trim()), !n && 1 === e.split("#").length)) {
        ...
        if (w)
          return (
            ...
            w[2]
              ? ((this.search = w[2]),
                (this.query = t ? k.parse(this.search.substr(1)) : this.search.substr(1)))
      ...
      (s.prototype.resolveObject = function (e) {
        ...
        if (
          ...
          S || (S = []), S.pop(), (S = S.concat(p)), (n.search = e.search), (n.query = e.query);
        ...
        for (
          var I = S.slice(-1)[0],
            E = ((n.host || e.host || S.length > 1) && ("." === I || ".." === I)) || "" === I,
            M = 0,
            A = S.length;
          A >= 0;
          A--
      ...
      /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (s) {
        ...
        function I(e) {
          ...
          for (i = r = T.length, r && T.push("-"); i < y; ) {
            ...
            for (
              o - t > p((c - n) / (k = i + 1)) && m("overflow"), n += (o - t) * k, t = o, a = 0;
              a < y;
              ++a
            )
              if (((d = e[a]) < t && ++n > c && m("overflow"), d == t)) {
                for (h = n, u = l; !(h < (f = u <= s ? 1 : u >= s + 26 ? 26 : u - s)); u += l)
                  (b = h - f), (w = l - f), T.push(g(x(f + (b % w), 0))), (h = p(b / w));
    ...
    e.exports = function (e, t, n, s) {
      ...
      for (var h = 0; h < l; ++h) {
        var u,
          ...
          g = e[h].replace(o, "%20"),
          m = g.indexOf(n);
        m >= 0 ? ((u = g.substr(0, m)), (f = g.substr(m + 1))) : ((u = g), (f = "")),
      ...
      var t = n(68),
        ...
        a = function (e, n) {
          e.constructor == String
            ? (e = n && "binary" === n.encoding ? s.stringToBytes(e) : i.stringToBytes(e))
            : r(e)
                          ...
                          (h = m(
                            (h = g(
                                    ...
                                    (h = p(
                                      (h = p(
                                        ...
                                        (u = p(
                                          ...
                                          (f = p(
                                            f,
                                            (l = p(l, h, u, f, o[d + 8], 7, 1770035416)),
                                            h,
                                            u,
                                            o[d + 9],
                                            12,
                                      ...
                                      (u = p(
                                        ...
                                        (f = p(
                                          f,
                                          (l = p(l, h, u, f, o[d + 12], 7, 1804603682)),
                                          h,
                                          u,
                                          o[d + 13],
                                          12,
                              ...
                              (u = g(
                                ...
                                (f = g(
                                  f,
                                  (l = g(l, h, u, f, o[d + 13], 5, -1444681467)),
                                  h,
                                  u,
                                  o[d + 2],
                                  9,
      ...
      (this.update = function (e) {
        if (this.active) {
              ...
              if (this.chargePlayer) {
                for (var h, u, f, d = 0; d < i.length; ++d)
                  !i[d].alive ||
                    ...
                    ((f = s.getDistance(this.x, this.y, i[d].x, i[d].y)) <= this.viewRange &&
                      (!h || f < u) &&
                      ((u = f), (h = i[d])));
                h
                  ? ((this.chargeTarget = h), (this.moveCount = s.randInt(8e3, 12e3)))
          ...
          if (this.hitWait > 0 && ((this.hitWait -= e), this.hitWait <= 0)) {
            ...
            for (var M = t.getGridArrays(this.x, this.y, this.hitRange), A = 0; A < M.length; ++A)
              for (b = 0; b < M[A].length; ++b)
                (S = M[A][b]).health &&
                  (T = s.getDistance(this.x, this.y, S.x, S.y)) < S.scale + this.hitRange &&
          ...
          this.x - P < 0
            ...
            : this.x + P > a.mapScale && ((this.x = a.mapScale - P), (this.xVel = 0)),
            this.y - P < 0
              ? ((this.y = P), (this.yVel = 0))
              : this.y + P > a.mapScale && ((this.y = a.mapScale - P), (this.yVel = 0));
        }
      }),
        (this.canSee = function (e) {
          if (!e) return !1;
        ...
        (this.changeHealth = function (e, t, n) {
          if (
            ...
            t &&
              t.canSee(this) &&
              e < 0 &&
              c.send(t.id, "t", Math.round(this.x), Math.round(this.y), Math.round(-e), 1),
            this.health <= 0 &&
              (this.spawnDelay
